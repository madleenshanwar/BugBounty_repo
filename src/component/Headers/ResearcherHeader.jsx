...
export default function HomeHeader() {
  ...
  return (
    <div>
      <Box px={64} h={80} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0px 4px 10px rgba(0,0,0,0.20)' }} >


        <Image
          radius="md" h={48} w={131} src="\assets\images\Vector.png" />
        <Flex align='center' justify="space-between" >
          ...
          <Button
            ...
            style={{ color: primaryColor, fontSize: "20px", fontWeight: 700 }}
            onClick={() => {
              navigate('/ResearcherTable')
            }}
          >
            {t('loopholes')}
          </Button>

          <Image src='/assets/images/profile.png' radius="xl" w={'40'} h={40} onClick={() => { navigate('/ResarherInformation') }} className='cursor' />
          <Button variant='transparent' color={primaryColor} ml={16}>  <LiaBell size="24" />  </Button>
          
          {dark ? <Button radius={8} variant='transparent' color={primaryColor} onClick={handleDark}>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke={primaryColor} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-moon"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
          </Button> : <Button radius={8} variant='transparent' color={primaryColor} onClick={handleDark}>
