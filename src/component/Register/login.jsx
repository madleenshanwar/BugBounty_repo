...
import LoginResearcher from '../Reseacher/LoginResearcher';
    ...
    <div style={{ zIndex: 2 }}>
        ...
        <Tabs w={652} mt={24} color="#990000" variant="pills" value={activeTab} onChange={setActiveTab}>
          <Tabs.List grow justify="space-between">
            <Tabs.Tab h={40} value="first"><Text fs='24' fw={700}>{t("Login as a security researcher")}</Text> </Tabs.Tab>
            <Tabs.Tab h={40} value="second"><Text fs='24' fw={700} >{t("Login as a company")}</Text> </Tabs.Tab>
          </Tabs.List>
