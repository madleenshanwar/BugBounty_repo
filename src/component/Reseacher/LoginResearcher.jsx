...
import { LoginForResearcher } from '../../Api/researcher/Auth/Login';
/*first page */
...
export default function LoginResearcher() {
    ...
    const handleLogin = async (e) => {
      ...
      try {
        ...
        setErrors({});
        // LoginResearcher(login);
        const result=await LoginForResearcher(login);
        console.log('Researcher register',result.data)
      ...
      >
        ...
        <Flex direction="column">
          ...
          <Button
            variant="transparent"
            color="black"
            style={{ alignSelf: "start", textDecoration: "underline" }}
